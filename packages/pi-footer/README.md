...
| `layout.left` | (`path` \| `branch` \| `provider` \| `model` \| `thinking` \| `mcp` \| `context` \| string)[] | *See JSON below ↓* | Footer slot IDs shown on the left in display order. |
| `layout.right` | (`path` \| `branch` \| `provider` \| `model` \| `thinking` \| `mcp` \| `context` \| string)[] | *See JSON below ↓* | Footer slot IDs shown on the right in display order. |
